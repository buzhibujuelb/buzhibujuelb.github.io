...
create: function() { 
					...
					var space_key = this.game.input.keyboard.addKey(Phaser.Keyboard.K);
					space_key.onDown.add(this.jump, this);
					var space_key2 = this.game.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR);
					space_key2.onDown.add(this.jump2, this); 
